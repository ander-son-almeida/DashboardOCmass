...
plot_int.update_layout(title='αA = {} ± {};  αB = {} ± {};  Mc = {} ± {}'.format(np.around(alpha_high_mass,decimals=2),
...
with container2:
    ...
    # with col4:
    st.metric("$Teste_{a}$", value=np.around(alpha_high_mass,decimals=2), delta=np.around(alpha_high_mass_error,decimals=2))
