...
if ticket_on_off:
    ...
    Av_range = st.sidebar.slider('Av (mag):', cluster['Av'].min(), cluster['Av'].max(), (1.0, 3.0), 0.1)
    FeH_range = st.sidebar.slider('FeH:', cluster['FeH'].min(), cluster['FeH'].max(), (0.2, 1.0), 0.1)
